...
using CostumeSanityChecker = MonkeyIslandSpecialEditionSpriteEditor.Formats.Costumes.SanityChecker;
...
namespace Tests
{
	...
	public class CostumePackerRoundTripTests
	{
		...
		public void SoundNames_AreParsedAndSurviveRoundTrip()
		{
			...
			Assert.That( soundFrames.All( f => f.Command == MonkeyIslandSpecialEditionSpriteEditor.Formats.Costumes.Entities.Frame.PlaySoundCommand ), Is.True );
		}
